# Strategie podziału dokumentów

## 1. Fixed Size Chunking (Podział o stałym rozmiarze)
...
## 2. Recursive Chunking (Podział rekursywny)
...
## 3. Document Structure Based Chunking (Podział oparty na strukturze)
...
## 4. Semantic Chunking (Podział semantyczny)
...
## 5. LLM Based Chunking (Podział oparty na LLM / Propositional Chunking)
